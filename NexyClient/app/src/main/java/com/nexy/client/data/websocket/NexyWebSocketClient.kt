...
class NexyWebSocketClient(
    ...
    fun sendTextMessage(chatId: Int, senderId: Int, content: String, messageId: String? = null) {
        Log.d(TAG, "Sending text message: chatId=$chatId, senderId=$senderId, content='$content'")
